  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="flex justify-between mt-8">
        ...
        {phase === 'complete' && (
          <Link href="/agents/transportation" className="flex items-center gap-2 bg-sky-600 text-white px-6 py-3 rounded-lg hover:bg-sky-700 font-semibold transition-colors">
