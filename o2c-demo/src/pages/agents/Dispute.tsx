  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="flex justify-between mt-8">
        <Link to="/agents/shipment-tracking" className="flex items-center gap-2 text-slate-500 hover:text-slate-700">
          <ArrowLeft className="h-4 w-4" /> Shipment Tracking
        </Link>
        {phase === 'complete' && (
          <Link to="/agents/pod-collector" className="flex items-center gap-2 bg-sky-600 text-white px-6 py-3 rounded-lg hover:bg-sky-700 font-semibold transition-colors">
